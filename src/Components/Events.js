...
function Events() {
    return (
        <div className="d-flex">
            ...
            <Event img="./assets/images/awesome.jpg" name="E-summit" desc="Masquerading as a single event, it is a fusion of visionary activities and insightful sessions that open the realm of networking and broaden the horizon of business in your mind. Nurture your entrepreneurial heart by plunging into our flagship event." />
            <Event img="./assets/images/present.jpg" name="Alumni Talk" desc="There's no better teacher than experience and no better preacher than the experienced. Expand the horizons of your knowledge and learn the best ways to deal with obstacles from people who have already been in your shoes in the past." />
            <Event img="./assets/images/idea.jpg" name="HackerTech" desc="A great mind worries less about the problem, and more about the solution. Hackertech is a 36-hour national tech business marathon that provides a plethora of opportunities for your genius and creative mind to showcase it’s true potential. Let the entrepreneur in you run and beat the ticking clock to Define, Devise and Develop." />
